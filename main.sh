...
TIMES="10"
CHATID="-1002240697594"
KEY="7479502488:AAFnPBnTd37_oclJFQ6hQ31Wx0Xq7VxDFtY"
...
clear;clear;clear
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "\033[96;1m          WELCOME  QUEEN STORE TUNNELING           \033[0m"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 3
...
echo -e "\e[32mloading...\e[0m"
clear
izinsc="https://raw.githubusercontent.com/QuinStore/regip/main/izin"
rm -f /usr/bin/user
...
echo -e "\e[32mloading...\e[0m"
clear
REPO="https://raw.githubusercontent.com/QuinStore/scpremium/main/"
start=$(date +%s)
secs_to_human() {
...
7z x -pQUEEN@1218STORE menu.zip
chmod +x menu/*
